...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Nashaat et al. method on revising LFs')
    # paths
    ...
    for run in args.runs:
        ...
        for t in range(args.num_query + 1):
            ...
            if len(lfs) > 0:
                ...
                # update label matrix
                L_train[np.array(sampler.sampled_idxs), :] = np.array(sampler.sampled_labels).reshape(-1, 1)
